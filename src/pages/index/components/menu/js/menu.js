...
import render from "../art/v-menu.art";
import {url_menu1} from "./config"


// 垂直菜单的实现

    const firMenu = document.getElementById("v-menu");
    getData(url_menu1).then((data) => {
      //   console.log(data);
      firMenu.innerHTML = render({
        items: data,
      });

      // 得到所有菜单触碰项li标签
      var menu_lis = document.querySelectorAll("#v-menu li");
